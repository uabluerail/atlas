  ...
  return (
    <div {...htmlProps} className="w-full">
      ...
      <input
        id={inputId}
        type="text"
        className="block w-full xs:text-xs xs:max-w-40 mobile:max-w-52 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 desktop:text-sm desktop:leading-6 pl-3"
