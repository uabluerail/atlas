...
const LayoutMenu: FC<LayoutMenuProps> = ({
    ...
    return (
        <Menu as="div" className="absolute inline-block text-left">
            ...
            >
                <Menu.Items className="absolute bottom-5 right-0 z-10 w-40 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <div className="py-1">
                        {buildMenu(
                            setLoading,
                            setGraphShouldUpdate,
