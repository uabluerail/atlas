...
const Footer: FC<FooterProps> = ({ graph, currentLanguage, setCurrentLanguage }) => {
    return (
                ...
                <span className="footer-text text-xs">
                    {config.legend.author &&
                        <div>
                            ...
                            <LanguagePicker currentLanguage={currentLanguage} setCurrentLanguage={setCurrentLanguage} />
